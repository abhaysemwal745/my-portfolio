...
buttons.forEach((btn) => {
  if (btn.innerText.includes("Download")) {
    btn.addEventListener("click", () => {
      window.open("/assets/Abhay_CV.pdf", "_blank");
    });
  }
  ...
  btns.forEach((btn) => {
    if (btn.innerText.includes("Live")) {
      btn.addEventListener("click", () => {
        if (title.includes("Decision")) {
          window.open(
            "https://abhaysemwal745.github.io/decision-fatigue-simulator/",
            "_blank"
          );
        }
      });
    ...
    if (btn.innerText.includes("Github")) {
      btn.addEventListener("click", () => {
        if (title.includes("Decision")) {
          window.open(
            "https://github.com/abhaysemwal745/decision-fatigue-simulator",
            "_blank"
          );
        }
      });
    ...
    if (btn.innerText.includes("Github")) {
      btn.addEventListener("click", () => {
        if (title.includes("Portfolio")) {
          window.open(
            "https://github.com/abhaysemwal745/my-portfolio",
            "_blank"
          );
        }
      });
